...
function dtd2array(keyboard: { keymapper: { i: number, m: '' | 'shift' | 'alt' }[], DTDKeyboardLayout: DTDTypes.RootObject }) {
    ...
    return [...parseMap(keyboard.DTDKeyboardLayout.keyboard.keyMap[0].map),
    ...parseMap(keyboard.DTDKeyboardLayout.keyboard.keyMap[1].map, 'shift'),
    ...parseMap(keyboard.DTDKeyboardLayout.keyboard.keyMap[4].map, 'alt')];
}
