...
export const DTDKeyboardLayout = {
  ...
  "keyboard": {
    ...
    "keyMap": [
      ...
      {
        "-modifiers": "altR+caps? ctrl+alt+caps?",
        "map": [
          {
            "-iso": "E02",
            "-to": "@",
